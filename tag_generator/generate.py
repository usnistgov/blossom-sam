...
# Function for returning an XML swid tag
def generateSwidXML(name, versionNum):
    ...
    software_identity = create_software_identity_element(
        {
            ...
            "package_info": PackageInfo(name, version = versionNum),
            "xml_lang": "en-US",
    ...
    return XML_DECLARATION.encode('utf-8') + swidtag
